...
import { Code, Globe, Lock, Shield, Terminal, ExternalLink, X, ChevronRight, Tag, Play, ArrowUpRight } from 'lucide-react'
...
export function ProjectsShowcase() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "Modernizing an online store for better user experience and conversion.",
      image: "/images/dashboard-screenshot.png", // Placeholder image
      tags: ["Web Design", "UI/UX", "E-commerce"],
    },
    {
      name: "Mobile App Development",
      description: "Building a cross-platform mobile application for a startup.",
      image: "/images/pufftrak-device-1.png", // Placeholder image
      tags: ["Mobile", "React Native", "Backend"],
    },
    {
      name: "Brand Identity Creation",
      description: "Developing a complete brand identity for a new business.",
      image: "/images/bevel-razors.png", // Placeholder image
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
              ...
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-t ${getCategoryColor((project as any).category)} opacity-20`}
                    ></div>
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant="outline" className="text-xs bg-background/50">
                        {getCategoryName((project as any).category)}
                      </Badge>
                    </div>

                    <p className="text-foreground text-sm leading-relaxed">{(project as any).description}</p>

                    <div className="flex flex-wrap gap-2">
                      {(project as any).technologies?.slice(0, 3)?.map((tech, index) => (
                        <span
                          key={index}
                      ...
                      {(project as any).technologies?.length > 3 && (
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs bg-muted text-muted-foreground border border-border">
                          +{(project as any).technologies.length - 3} more
                        </span>
                      )}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {projects.filter((project) => !(project as any).category).map((project, index) => (
              <Card key={index} className="overflow-hidden">
                ...
                <CardContent>
                  ...
                  <a href="#" className="inline-flex items-center text-primary hover:underline text-sm">
