...
export function SkillsVisualization() {
  ...
  const skills: Skill[] = [
    ...
    { name: "React", level: 90, category: "Web Development", description: "Frontend development using React", color: "#61DAFB" },
    { name: "Next.js", level: 85, category: "Web Development", description: "Server-side rendering with Next.js", color: "#000000" },
    { name: "TypeScript", level: 80, category: "Web Development", description: "Static typing with TypeScript", color: "#3178C6" },
    { name: "Tailwind CSS", level: 95, category: "Web Development", description: "Utility-first CSS framework", color: "#38B2AC" },
    { name: "Node.js", level: 75, category: "Web Development", description: "Backend development using Node.js", color: "#339933" },
    { name: "Framer Motion", level: 88, category: "Web Development", description: "Animations with Framer Motion", color: "#EE5C9B" },
  ]
          ...
          <motion.div variants={itemVariants} className="mt-12">
            ...
            <div className="space-y-6">
              {skills.map((skill) => (
                <div
                  key={skill.name}
                  className="relative h-8 bg-muted rounded-full overflow-hidden"
                ...
                >
                  ...
                  />
                  <div className="relative z-10 flex items-center justify-between h-full px-4 text-sm font-medium text-white">
