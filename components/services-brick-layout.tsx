...
export function ServicesBrickLayout() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Chatbots inteligentes que automatizam o atendimento ao cliente 24/7 via WhatsApp.",
      span: "col-span-1",
    },
    {
      icon: <Zap className="w-6 h-6" />,
    ...
    {
      title: "IA para Atendimento WhatsApp",
      description: "Chatbots inteligentes que automatizam o atendimento ao cliente 24/7",
      icon: <Zap className="w-6 h-6" />,
        ...
        >
          ...
          >
            {services.map((service, index) => (
              ...
              >
                {service.span ? (
                  <Card className={`flex flex-col items-center text-center p-6 ${service.span}`}>
          ...
          <motion.div variants={itemVariants} className="text-center pt-8">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-emerald-500 text-emerald-400 hover:bg-emerald-500/10 px-12 py-4 text-lg bg-transparent"
              >
