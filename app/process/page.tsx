...
import { MessageCircle, Search, Code, TestTube, Rocket, LifeBuoy, CheckCircle, Clock, Users, Target, Lightbulb, FileText, Zap, Shield, TrendingUp, Calendar, ArrowRight, Play } from 'lucide-react'
...
export default function ProcessPage() {
  ...
  const updatedProcessSteps = [
    {
      icon: Lightbulb,
      title: "1. Descoberta e Análise",
      description: "Entendemos profundamente seu negócio, mercado e objetivos para traçar a melhor estratégia.",
      details: [
    ...
    },
    {
      ...
      description: "Desenvolvemos um plano de ação personalizado, com táticas e ferramentas ideais para seu sucesso.",
      details: [
        "Criação de personas e jornada do cliente",
        "Definição de canais e orçamentos",
        "Cronograma de execução",
      ],
    },
    {
      icon: Rocket,
      title: "3. Execução e Implementação",
      description: "Colocamos a estratégia em prática, construindo e otimizando todas as ferramentas necessárias.",
      details: [
        "Desenvolvimento de sites/landing pages",
        "Configuração de campanhas de tráfego pago",
        "Implementação de CRM e automação",
      ],
    },
    {
      icon: TrendingUp,
      title: "4. Otimização e Escala",
      description: "Monitoramos constantemente os resultados, ajustando e escalando as ações para maximizar o ROI.",
      details: [
        "Análise de dados e relatórios periódicos",
        "Testes A/B e otimizações contínuas",
        "Escala de campanhas e prospecção",
      ],
    },
    {
      icon: Users,
      title: "5. Capacitação e Suporte",
      description: "Capacitamos sua equipe e oferecemos suporte contínuo para garantir a sustentabilidade do crescimento.",
      details: [
        "Treinamentos comerciais personalizados",
    ...
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-2xl font-bold mb-8 text-center">Our Updated Process Steps</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {updatedProcessSteps.map((step, index) => (
